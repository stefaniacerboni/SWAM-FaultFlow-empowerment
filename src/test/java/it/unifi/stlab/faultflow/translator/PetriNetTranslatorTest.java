...
public class PetriNetTranslatorTest {
    ...
    private void buildExpectedPN() {
        ...
        expectedMarking.setTokens(A_Fault1Occurrence, 1);
        expectedMarking.setTokens(A_Fault2, 0);
        expectedMarking.setTokens(A_Fault2Occurrence, 1);
        expectedMarking.setTokens(A_Fault3, 0);
        expectedMarking.setTokens(A_Fault3Occurrence, 1);
        expectedMarking.setTokens(A_Fault4, 0);
        expectedMarking.setTokens(A_Fault4Occurrence, 1);
        expectedMarking.setTokens(A_Fault5, 0);
        expectedMarking.setTokens(A_Fault5Occurrence, 1);
        ...
        expectedMarking.setTokens(B_Fault1Occurrence, 1);
        expectedMarking.setTokens(B_Fault2, 0);
        expectedMarking.setTokens(B_Fault2Occurrence, 1);
        expectedMarking.setTokens(B_Fault3, 0);
        expectedMarking.setTokens(B_Fault3Occurrence, 1);
        ...
        expectedMarking.setTokens(C_Fault6Occurrence, 1);
        ...
        a_Failure1.addFeature(StochasticTransitionFeature.newErlangInstance(Integer.parseInt("5"), new BigDecimal("1.0")));
        a_Failure2.addFeature(new EnablingFunction("(A_Fault3>0)&&((A_Fault4>0)||(A_Fault5>0))"));
        a_Failure2.addFeature(StochasticTransitionFeature.newErlangInstance(Integer.parseInt("7"), new BigDecimal("1.0")));
        a_Failure3.addFeature(new EnablingFunction("(A_Fault2>0)||(A_Fault5>0)"));
        a_Failure3.addFeature(StochasticTransitionFeature.newErlangInstance(Integer.parseInt("9"), new BigDecimal("1.0")));
        ...
        b_Failure1.addFeature(StochasticTransitionFeature.newErlangInstance(Integer.parseInt("6"), new BigDecimal("1.0")));
        b_Failure2.addFeature(new EnablingFunction("(B_Fault1>0)&&(B_Fault3>0)"));
        b_Failure2.addFeature(StochasticTransitionFeature.newErlangInstance(Integer.parseInt("2"), new BigDecimal("1.0")));
        ...
        c_Failure1.addFeature(StochasticTransitionFeature.newErlangInstance(Integer.parseInt("2"), new BigDecimal("1.0")));
        c_Failure2.addFeature(new EnablingFunction("(C_Fault6>0)&&(C_Fault4>0)"));
        c_Failure2.addFeature(StochasticTransitionFeature.newErlangInstance(Integer.parseInt("2"), new BigDecimal("1.0")));
        c_Failure3.addFeature(new EnablingFunction("(C_Fault5>0)&&(C_Fault6>0)"));
        c_Failure3.addFeature(StochasticTransitionFeature.newErlangInstance(Integer.parseInt("2"), new BigDecimal("1.0")));
