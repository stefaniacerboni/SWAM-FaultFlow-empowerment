...
public class NewModelExample {
    ...
    public static void build() {
        ...
        eM_A1.setEnablingCondition("A_Fault1 && (A_Fault2 || A_Fault3)");
        ...
        eM_A2.setEnablingCondition("A_Fault2 && A_Fault3");
        eM_A2.setPDF("exp(5)");
        ...
        eM_B1.setEnablingCondition("B_Fault1 && B_Fault2");
        eM_B1.setPDF("exp(3)");
        ...
        eM_C1.setEnablingCondition("C_Fault1 && C_Fault2");
        eM_C1.setPDF("exp(3)");
        ...
        eM_C2.setEnablingCondition("C_Fault3 && C_Fault4");
        eM_C2.setPDF("exp(3)");
