...
import it.unifi.stlab.faultflow.model.operational.*;
...
public class SimpleSystem02Builder {
    private static SimpleSystem02Builder single_instance;
    ...
    public static SimpleSystem02Builder getInstance() {
        if (single_instance == null)
            single_instance = new SimpleSystem02Builder();
    ...
    public static void injectFaultsIntoScenario(Scenario scenario, String serial) {
        ...
        Error errorModeA = new Error("errorModeA", errorModes.get("A_ToFailure1"), BigDecimal.TEN);
