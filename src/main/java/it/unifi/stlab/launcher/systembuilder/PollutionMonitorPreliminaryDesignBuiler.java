...
public class PollutionMonitorPreliminaryDesignBuiler {
    ...
    private PollutionMonitorPreliminaryDesignBuiler() {
        ...
        system = new System("PollutionMonitorSystem_Preliminary");
        ...
        system.addComponent(pollutionMonitor,
                ...
                fieldDeviceSubsystem1PM10, fieldDeviceSubsystem2PM10, fieldDeviceSubsystem3PM10,
                mapReduceProcessorPM10,
                pm10Sensor1, pm10Sensor2, pm10Sensor3);
        ...
        persistenceSystem.addCompositionPorts(is1Ps, is2Ps, is3Ps);
        ...
        em_cdp.addInputFaultMode(exFM_pm10drf);
        em_cdp.addOutputFailureMode(fM_acdf);
        em_cdp.setEnablingCondition("1/1(PM10DataRefinementFault)", faultModes);
