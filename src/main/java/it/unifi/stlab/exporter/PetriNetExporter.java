...
public class PetriNetExporter {
    public static PetriNetTranslator exportPetriNetFromSystem(System system, PetriNetExportMethod method) throws JAXBException, FileNotFoundException {
        ...
        XPNExporter.export(new File("src/main/java/it/unifi/stlab/exporter/files/"+system.getName() +"_"+ method.toString() + "_Fault2Failure.xpn"),
                new OrderByComponentToXPN(system, pnt.getPetriNet(), pnt.getMarking()));
        XPNExporter.export(new File("src/main/java/it/unifi/stlab/exporter/files/"+system.getName() +"_"+ method.toString() + "_Fault2Failure_Basic.xpn"),
